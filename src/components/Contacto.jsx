...
export default function Page () {
  ...
  return (
    <section id='contacto' className='isolate bg-white px-6 py-24 sm:py-32 lg:px-8'>
      <div
      ...
      <div className='mx-auto max-w-2xl text-center'>
        ...
        Ponte en contacto con AwakeSeller hoy mismo y descubre cómo nuestra plataforma de analítica de productos puede potenciar tu éxito como vendedor en Etsy. Estamos ansiosos por responder a tus preguntas, escuchar tus comentarios y ayudarte a alcanzar tus metas en el mundo del comercio electrónico.
        </p>
      </div>
